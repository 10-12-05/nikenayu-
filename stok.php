...
<head>
  ...
  <title>Manajemen stok - NIKENCANTIK</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/komputer.jpg" rel="icon">
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo d-flex align-items-center">
        <img src="assets/img/komputer.jpg" alt="">
        <span class="d-none d-lg-block">NIKENCANTIK</span>
      </a>
              ...
              <li class="nav-item dropdown pe-3">
                ...
                <ul 
                  ...
                  <li class="dropdown-header">
                    <h6><?php echo isset($_SESSION['nama']) ? $_SESSION['nama'] : 'NIKEN AYU'; ?></h6>
...
<div class="mb-3">
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>NIKENCANTIK</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      Designed by <a href="https://bootstrapmade.com/">NIKENCANTIK</a>
    </div>
  </footer><!-- End Footer -->
